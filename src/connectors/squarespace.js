...
class SquarespaceConnector extends BasePlatformConnector {
    ...
    static icon = `<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M47.5 16.5c-2.8-2.8-7.4-2.8-10.2 0L22.2 31.6c-2.8 2.8-2.8 7.4 0 10.2 2.8 2.8 7.4 2.8 10.2 0l15.1-15.1c2.8-2.8 2.8-7.4 0-10.2zm-2.5 7.7L29.9 39.3c-1.4 1.4-3.8 1.4-5.2 0-1.4-1.4-1.4-3.8 0-5.2L39.8 19c1.4-1.4 3.8-1.4 5.2 0 1.4 1.4 1.4 3.8 0 5.2z" fill="#000"/><path d="M31.8 22.2L16.7 37.3c-2.8 2.8-2.8 7.4 0 10.2 1.4 1.4 3.3 2.1 5.1 2.1 1.8 0 3.7-.7 5.1-2.1l15.1-15.1c2.8-2.8 2.8-7.4 0-10.2-2.8-2.8-7.4-2.8-10.2 0zm7.7 2.5L24.4 39.8c-1.4 1.4-3.8 1.4-5.2 0-1.4-1.4-1.4-3.8 0-5.2l15.1-15.1c.7-.7 1.6-1.1 2.6-1.1 1 0 1.9.4 2.6 1.1 1.4 1.4 1.4 3.8 0 5.2z" fill="#000"/><path fill-rule="evenodd" clip-rule="evenodd" d="M16.5 16.5c-2.8 2.8-2.8 7.4 0 10.2l15.1 15.1c2.8 2.8 7.4 2.8 10.2 0 2.8-2.8 2.8-7.4 0-10.2L26.7 16.5c-2.8-2.8-7.4-2.8-10.2 0zm2.5 7.7c-1.4-1.4-1.4-3.8 0-5.2 1.4-1.4 3.8-1.4 5.2 0l15.1 15.1c1.4 1.4 1.4 3.8 0 5.2-1.4 1.4-3.8 1.4-5.2 0L19 24.2z" fill="#000"/></svg>`;
