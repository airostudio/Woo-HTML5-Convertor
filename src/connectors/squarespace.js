...
class SquarespaceConnector extends BasePlatformConnector {
    ...
    static icon = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.53 14.03l-1.06 1.06a.75.75 0 01-1.06 0l-2.94-2.94-2.94 2.94a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 010-1.06l2.94-2.94-2.94-2.94a.75.75 0 010-1.06l1.06-1.06a.75.75 0 011.06 0l2.94 2.94 2.94-2.94a.75.75 0 011.06 0l1.06 1.06a.75.75 0 010 1.06l-2.94 2.94 2.94 2.94a.75.75 0 010 1.06z"/></svg>`;
